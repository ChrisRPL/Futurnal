      ...
      <main className="flex-1 flex items-center justify-center px-8 py-12">
        <div className="w-full max-w-md animate-fade-in">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                <label htmlFor="password" className="text-sm text-[var(--color-text-tertiary)]">
                  Password
                </label>
                <Link
                  to="/forgot-password"
                  className="text-sm text-[var(--color-text-muted)] hover:text-[var(--color-text-tertiary)] transition-colors no-underline"
                >
                  Forgot?
                </Link>
              </div>
          ...
          <p className="mt-8 text-center text-sm text-[var(--color-text-muted)]">
            ...
            <Link to="/signup" className="text-[var(--color-text-tertiary)] hover:text-[var(--color-text-primary)] transition-colors">
              Create one
            </Link>
          </p>
        </div>
