 ...
 * Checkbox Component
 *
 * Checkbox using Radix UI primitives.
...
>(({ className, ...props }, ref) => (
  <CheckboxPrimitive.Root
    ref={ref}
    className={cn(
      'peer h-4 w-4 shrink-0 border border-[var(--color-border-active)]',
      ...
      'data-[state=checked]:bg-[var(--color-inverse-bg)] data-[state=checked]:text-[var(--color-inverse-text)]',
      className
    )}
    {...props}
  >
